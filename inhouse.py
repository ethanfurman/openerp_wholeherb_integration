...
class Product_In_Info(osv.Model):
    ...
    _columns = {
        ...
        'process' : fields.selection(_select_process, string='Process', help='Process to be done'),
        'equip_to_use' : fields.selection(_select_equip_to_use, string='Equip To Use', help='Machine to use for job'),
        'product_id' : fields.many2one(
                'product.product',
                string='Product Description',
                help='Item Code & Description of product going into process',
                ),
        'raw_lot_number' : fields.char('Raw Lot#', size=64, help='Lot# of product going into process'),
...
class Job_Time(osv.Model):
    ...
    _columns = {
        ...
        'lot_number_raw' : fields.char('Lot# Raw', size=64, help='Preprocess lot#'),
        'lot_number_finished' : fields.char('Lot# Finished', size=64, help='Finished lot#'),
...
class Finished_Product_Info(osv.Model):
    ...
    _columns = {
        ...
        'lot_number_finished1' : fields.char('Lot# Finished1', size=64, help='Lot# of primary finished product'),
        ...
        'lot_number_overs' : fields.char('Lot# Overs', size=64, help='Lot# of overs'),
        ...
        'lot_number_unders' : fields.char('Lot# Unders', size=64, help='Lot# of unders'),
